"""Path helpers for the local Weaveflow workspace."""
...
WORKSPACE_NAME = ".weaveflow"
LEGACY_WORKSPACE_NAME = ".projectops"
...
class WorkspacePaths:
    ...
    @property
    def root(self) -> Path:
        current_root = self.base_dir / WORKSPACE_NAME
        legacy_root = self.base_dir / LEGACY_WORKSPACE_NAME
        if not current_root.exists() and legacy_root.exists():
            return legacy_root
        return current_root
