"""Service-backed adapter dispatcher for Weaveflow operations."""
...
from weaveflow.adapters.base import AdapterRequest, AdapterResponse
...
class WeaveflowServiceAdapter:
    """Translate adapter requests into Weaveflow service function calls."""
...
ProjectOpsServiceAdapter = WeaveflowServiceAdapter
