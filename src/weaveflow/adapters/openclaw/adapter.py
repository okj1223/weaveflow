"""Placeholder OpenClaw adapter built on the local Weaveflow adapter pipeline."""
...
from weaveflow.adapters.confirmation import is_confirmation_response
from weaveflow.adapters.events import event_from_turn_result
...
from weaveflow.adapters.session import AdapterTurnResult


class OpenClawAdapter:
    """Route OpenClaw-like messages through the local Weaveflow adapter pipeline."""
